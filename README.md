...
* [`src/ubtest/`](src/ubtest/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/ubtest/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `ubtest` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/ubtest/config.cljs) defaults to `true` in
...
```clj
(ns ubtest.example
  (:require [ubtest.config :as config])
